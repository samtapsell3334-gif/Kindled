# The Customer Film — script (v6 WS-V3)

**Runtime:** 60s ±5 · **Placement:** linked from the footer of every public page ·
**British English. Captions-first. No claim conflicts with the site.**

Format: `[start–end] SCENE | ON-SCREEN TEXT | VO line`

---

[00–12] **The old world — fast and funny.** Four quick pain frames: the "what does she
want??" group chat; two identical presents colliding; the awkward "everyone send me £10"
text; the drawer of unwanted gifts.
...
ON-SCREEN: "Then — the reveal."
VO: "Then comes the bit nobody forgets. The reveal: the total, the people, the messages — together, on the day."

[50–58] **Why it's better for everyone.** Three fast frames.
ON-SCREEN: "Organisers: no chasing. · Contributors: 30 seconds, no account. · Receivers: the thing they actually dreamed of."
VO: "Organisers never chase. Contributors are done in thirty seconds. And the person you love gets the thing they actually dreamed of."

[58–60] **CTA end-card.**
ON-SCREEN: "Gifting, reignited. → kindledgift.co.uk"
VO: "Kindled. Gifting, reignited."
...
scenes when MP4s are needed (see PLAN.md pipeline decision — TODO-FOUNDER).
